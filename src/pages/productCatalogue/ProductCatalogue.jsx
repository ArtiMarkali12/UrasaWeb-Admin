...
const ProductCatalogues = () => {
  ...
  const fetchProductCatalogues = async () => {
    try {
      ...
      showToast("Failed to fetch Product Catalogue quotes", "error");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleDelete = async (id) => {
    if (
      window.confirm(
        "Are you sure you want to delete this Product Catalogue quote?",
      )
    ) {
      try {
        await productCatalogueAPI.delete(id);
        setProductCatalogues(productCatalogues.filter((b) => b._id !== id));
        showToast("Product Catalogue quote deleted successfully", "success");
      } catch (error) {
        console.error("Error deleting Product Catalogue:", error);
        showToast("Failed to delete Product Catalogue quote", "error");
      }
    }
  };
  ...
  const handleEdit = (productCatalogue) => {
    setFormData({
      finishedSizeClosed:
        productCatalogue.formatAndBindingStyle?.finishedSizeClosed || "",
      bindingMethod:
        productCatalogue.formatAndBindingStyle?.bindingMethod || "",
      coverPaperHeavy:
        productCatalogue.paperStockSelection?.coverPaperHeavy || "",
      innerPagesText:
        productCatalogue.paperStockSelection?.innerPagesText || "",
      printColor: productCatalogue.paperStockSelection?.printColor || "",
      totalNumberOfPages:
        productCatalogue.pageCountAndColor?.totalNumberOfPages || "",
      coverFinishesAndExtras:
        productCatalogue.coverFinishesAndExtras?.join(", ") || "",
      quantity: productCatalogue.quantity || "",
      deadlineOrSpecialInstructions:
        productCatalogue.deadlineOrSpecialInstructions || "",
      customerName: productCatalogue.customerDetails?.name || "",
      customerEmail: productCatalogue.customerDetails?.email || "",
      customerPhone: productCatalogue.customerDetails?.phone || "",
      customerAddress: productCatalogue.customerDetails?.address || "",
      orderDate: productCatalogue.timeline?.orderDate
        ? new Date(productCatalogue.timeline.orderDate)
            .toISOString()
            .split("T")[0]
        : "",
    ...
    try {
      const updateData = {
        formatAndBindingStyle: {
          finishedSizeClosed: formData.finishedSizeClosed,
          bindingMethod: formData.bindingMethod,
        },
        paperStockSelection: {
          coverPaperHeavy: formData.coverPaperHeavy,
          innerPagesText: formData.innerPagesText,
          printColor: formData.printColor,
        },
        pageCountAndColor: {
          totalNumberOfPages: formData.totalNumberOfPages,
        },
        coverFinishesAndExtras: formData.coverFinishesAndExtras
          ? formData.coverFinishesAndExtras
              .split(",")
              .map((item) => item.trim())
              .filter((item) => item)
          : [],
        quantity: formData.quantity ? parseInt(formData.quantity) : undefined,
        deadlineOrSpecialInstructions: formData.deadlineOrSpecialInstructions,
        customerDetails: {
      ...
      showToast("Product Catalogue quote updated successfully", "success");
    } catch (error) {
      console.error("Error updating product catalogue:", error);
      showToast("Failed to update product catalogue quote", "error");
    }
  };
  ...
  const fetchDropdownOptions = async () => {
    try {
      const response = await productCatalogueOptionsAPI.getDropdown();
  ...
  const handleUpdateCategory = async (e) => {
    ...
    try {
      const response = await productCatalogueOptionsAPI.updateCategory(
        editingCategory,
        {
  ...
  const handleUpdateSubcategory = async (e) => {
    ...
    try {
      const response = await productCatalogueOptionsAPI.updateSubcategory(
        editingCategory,
        editingSubcategory,
        {
  ...
  return (
    <div className="product-catalogues-page">
      {toast.show && (
        ...
        <div className="tab-content">
          ...
          {loading ? (
            <div className="loading-container">
              ...
              <p>Loading Product Catalogue quotes...</p>
            </div>
          ) : (
            <div className="booklets-grid">
              {filteredProductCatalogues.length > 0 ? (
                  ...
                  <div key={productCatalogue._id} className="booklet-card">
                    ...
                    <div className="card-body">
                      ...
                      <div className="info-row">
                        ...
                        <span className="info-value">
                          {
                            productCatalogue.formatAndBindingStyle
                              ?.finishedSizeClosed
                          }
                        </span>
                      </div>
                      <div className="info-row">
                        <span className="info-label">Binding</span>
                        <span className="info-value">
                          {
                            productCatalogue.formatAndBindingStyle
                              ?.bindingMethod
                ...
                <div className="empty-state">
                  ...
                  <p>No Product Catalogue quotes found</p>
                </div>
              )}
            </div>
          )}
                                                  ...
                                                  <form
                                                    ...
                                                    onSubmit={async (e) => {
                                                      ...
                                                      try {
                                                        ...
                                                        const response =
                                                          await productCatalogueOptionsAPI.updateAttribute(
                                                            categoryKey,
                                                            subcatKey,
                                                            index,
                                                            {
        ...
        <div className="tab-content">
          <div className="view-options-header">
            <div>
              ...
              <p>
                View all product catalogue configuration options organized by
                categories
              </p>
            </div>
          </div>
        ...
        >
          ...
          >
            <div className="simple-modal-header">
              ...
              <p>Create a new category to manage product catalogue options</p>
            </div>
            <form
              ...
              <div className="simple-form-body">
                <div className="simple-form-group">
                  ...
                  <input
                    ...
                    placeholder="e.g., bindingMethods"
                    required
                  />
                  <small>
              ...
              <div className="simple-form-body">
                <div className="simple-form-group">
                  ...
                  <input
                    ...
                    placeholder="e.g., Binding Methods"
                    required
                  />
                </div>
                <div className="simple-form-group">
        ...
        >
          ...
          >
            ...
            <div className="modal-header">
              <h2>Product Catalogue Quote Details</h2>
            </div>
            <div className="modal-body">
              ...
              {renderDynamicData(selectedProductCatalogue)}
      ...
      {showEditModal && selectedProductCatalogue && (
        ...
        >
          ...
          >
            ...
            <div className="modal-header">
              <h2>Edit Product Catalogue Quote</h2>
            </div>
            <form onSubmit={handleEditSubmit}>
              <div className="modal-body">
                <div className="modal-section">
                  <h3>Format & Binding Style</h3>
                  <div className="form-grid">
                    <div className="form-group">
                      <label>Finished Size (Closed)</label>
                      <select
                        value={formData.finishedSizeClosed || ""}
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            finishedSizeClosed: e.target.value,
                          })
                        }
                      >
                        ...
                        {dropdownOptions
                          .find(
                            (opt) => opt.categoryKey === "finishedSizesClosed",
                          )
                          ?.attributes.map((attr) => (
                    ...
                    <div className="form-group">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            bindingMethod: e.target.value,
                          })
                        }
                      >
                        <option value="">Select Binding Method</option>
                        {dropdownOptions
                          .find((opt) => opt.categoryKey === "bindingMethods")
                          ?.attributes.map((attr) => (
                            <option key={attr} value={attr}>
                              {attr}
                            </option>
                ...
                <div className="modal-section">
                  ...
                  <div className="form-grid">
                    <div className="form-group">
                      <label>Cover Paper (Heavy)</label>
                      <select
                        value={formData.coverPaperHeavy || ""}
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            coverPaperHeavy: e.target.value,
                          })
                        }
                      >
                        <option value="">Select Cover Paper</option>
                        {dropdownOptions
                          .find((opt) => opt.categoryKey === "coverPaperHeavy")
                          ?.attributes.map((attr) => (
                            <option key={attr} value={attr}>
                              {attr}
                            </option>
                    ...
                    <div className="form-group">
                      <label>Inner Pages (Text)</label>
                      <select
                        value={formData.innerPagesText || ""}
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            innerPagesText: e.target.value,
                          })
                        }
                      >
                        <option value="">Select Inner Pages</option>
                        {dropdownOptions
                          .find((opt) => opt.categoryKey === "innerPagesText")
                          ?.attributes.map((attr) => (
                            <option key={attr} value={attr}>
                              {attr}
                            </option>
                ...
                <div className="modal-section">
                  <h3>Page Count & Color</h3>
                  <div className="form-grid">
                    <div className="form-group">
                      <label>Total Number of Pages</label>
                      <input
                        type="text"
                        value={formData.totalNumberOfPages || ""}
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            totalNumberOfPages: e.target.value,
                          })
                        }
                      />
                    </div>
                ...
                <div className="modal-section">
                  <h3>Cover Finishes & Extras</h3>
                  <div className="form-grid">
                    <div className="form-group full-width">
                      <label>Cover Finishes and Extras</label>
                      <input
                        type="text"
                        value={formData.coverFinishesAndExtras || ""}
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            coverFinishesAndExtras: e.target.value,
                          })
                        }
                ...
                <div className="modal-section">
                  <h3>Deadline & Instructions</h3>
                  <div className="form-grid">
                    <div className="form-group full-width">
                      <label>Deadline or Special Instructions</label>
                      <textarea
                        value={formData.deadlineOrSpecialInstructions || ""}
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            deadlineOrSpecialInstructions: e.target.value,
                          })
                        }
                        placeholder="Enter deadline or special instructions"
                        rows="3"
                      />
                    </div>
                  </div>
